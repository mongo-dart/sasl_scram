...
class SimpleScramSha256Example extends ScramExample {
  static final SimpleScramSha256Example _singleton = SimpleScramSha256Example._internal();
  ...
  @override
  String CLIENT_FINAL_MESSAGE_PROOF() => 'mU8grLfTjDrJer9ITsdHk0igMRDejG10EJPFbIBL3D0=';

  @override
  String CLIENT_FINAL_MESSAGE() => '${CLIENT_FINAL_MESSAGE_WITHOUT_PROOF()},p=${CLIENT_FINAL_MESSAGE_PROOF()}';

  @override
  String SERVER_FINAL_MESSAGE_PROOF() => 'jwt97IHWFn7FEqHykPTxsoQrKGOMXJl/PJyJ1JXTBKc=';
      ...
      : super(
          ScramMechanism(
            ...
            UsernamePasswordCredential(
                username: SimpleScramSha256Example().USER(), password: SimpleScramSha256Example().PASSWORD()),
